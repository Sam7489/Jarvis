...
# Async function to henerate images based on the given prompt
...
# Main loop to monitor for image generationrequests
while True:
    try:
        ...
        # If the status inicate an image generation request
        if Status == "True":
