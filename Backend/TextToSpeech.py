...
def TextToSpeech(Text, func=lambda r=None: True):
    ...
    # List of predefined responses for cases where the text is too l ong
    responses = [
    ...
    # If the text is very long ( move than 4 sentences and 250 characters), add a response message
