...
# Replace the language setting in the HTML code with the input language form the environment variables
...
# Function to modify a query to ensure poper punctuation and formatting.
